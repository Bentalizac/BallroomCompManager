    ...
    <>
      <main>
        ...
        <div className="flex flex-col">
          ...
          <div className="bg-accent px-20 py-13">
            <h1 className="text-4xl font-bold mb-2 text-accent-foreground">
              Competition Overview
            </h1>
                  ...
                  {displayData.isUpcoming && displayData.daysUntilStart > 0 && (
                    <div className="bg-accent-foreground/10 p-4 rounded-lg">
                      ...
                      <p className="text-sm">
                        ...
                        {displayData.daysUntilStart !== 1 ? "s" : ""} to go
                      </p>
                    </div>
                  )}
                </div>
          ...
          <div className="bg-secondary px-20 py-13">
            <h1 className="text-4xl font-bold mb-2 text-secondary-foreground">
              Events
            </h1>
            <div className="text-secondary-foreground">
              {competition?.events && competition.events.length > 0 ? (
                <div className="grid gap-4">
                  {competition.events.map((event: CompEvent) => (
                    <div
                      key={event.id}
      ...
      <footer className="bg-gray-100 py-8">
        <div className="max-w-4xl mx-auto px-4 text-center text-gray-600">
          <p>
            &copy; 2024 {competition?.name || "Competition"}. All rights
            reserved.
          </p>
        </div>
      </footer>
